package dorkbots.dorkbots_ui.shape_creators
{
	...
	public class AbstractShapeCreator
	{
		...
		private var _addFill:Boolean = true;
		
		public function AbstractShapeCreator()
		{
		}

		public final function set addFill(value:Boolean):void
		{
			_addFill = value;
		}
		...
		{
			graphics.clear();
			if (_lineAlpha > 0) graphics.lineStyle(_lineThickness, _lineColor, _lineAlpha);
			if (_addFill) graphics.beginFill(_fillColor, _fillAlpha);
		}
